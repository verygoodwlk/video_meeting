 ...
 * 编译语音合成任务
 *
 * {"id":"modifyVoiceTask","account":"admin", "taskid":"145"，"info":"欢迎光临", "reporter":"1", "speed":"50", "loopNum":"1", "taskname":"Region","taskPriority":0,"taskType":1,"stopDate":"2019-06-10","startTime":"16:22:53","users":["1"],"startDate":"2018-12-14","weekMask":254, "status":"0"}
 *
 * @Author ken
 * @Date 2019/2/26
 * @Version 1.0
 */
@Component("modifyVoiceTask")
public class SocketMsgUpdateVoiceTaskHandler extends SocketMsgHandler {
